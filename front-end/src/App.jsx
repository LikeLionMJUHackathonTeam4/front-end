...
function App() {
  ...
  const deleteToilet = (id) => {
    setToilets((prevToilets) =>
      prevToilets.filter((toilet) => toilet.id !== id)
    );
  };

  const deleteSmoking = (id) => {
    setSmokings((prevSmokings) =>
      prevSmokings.filter((smoking) => smoking.id !== id)
    );
  };
  ...
  return (
    <>
      <Routes>
        ...
        <Route
          path="/myplace"
          element={<MyPlace toilets={toilets} onDeleteToilet={deleteToilet} />}
        />
        <Route
          path="/myplacesmoking"
          element={
            <MyPlaceSmoking
              smokings={smokings}
              onDeleteSmoking={deleteSmoking}
            />
          }
        />
        <Route path="/selectmyplacetoilet" element={<SelectMyPlaceToilet />} />
        <Route
          path="/selectmyplacesmoking"
          element={<SelectMyPlaceSmoking />}
        />
        <Route
          path="/newmyplacetoilet"
          element={<NewMyPlaceToilet addToilet={addToilet} />}
        />
        <Route
          path="/newmyplacesmoking"
          element={<NewMyPlaceSmoking addSmoking={addSmoking} />}
        />
        <Route
          path="/editmyplacetoilet/:id"
          element={
            <EditMyPlaceToilet
              toilets={toilets}
              onUpdateToilet={updateToilet}
            />
          }
        />
        <Route
          path="/editmyplacesmoking/:id"
          element={
            <EditMyPlaceSmoking
              smokings={smokings}
              onUpdateSmoking={updateSmoking}
            />
          }
        />
