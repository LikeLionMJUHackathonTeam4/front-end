    ...
    <div className="MyPlace">
      <Header
        ...
        rightChild={
          <CustomButton
            text="추가"
            onClick={() => navigate("/newmyplacetoilet")}
          />
        }
      />

      <div className="choosePlace">
        <p className="Mytoilet" onClick={() => navigate("/myplace")}>
          화장실
        </p>
        <p className="Mysmoking" onClick={() => navigate("/myplacesmoking")}>
          흡연구역
        </p>
      </div>
        ...
        toilets.map((toilet) => (
          <div key={toilet.id} className="place">
            ...
            <div className="buttons">
              <CustomButton
                text="수정"
                onClick={() => handleEditClick(toilet.id)}
              />
              <CustomButton
                text="삭제"
                onClick={() => handleDeleteClick(toilet.id)}
              />
            </div>
            <hr className="bar" />
          </div>
